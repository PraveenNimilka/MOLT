...
- Windows 10/11 x64, Python 3.12, and an NVIDIA GPU with a compatible driver
- about 6 GB of free disk space for the isolated environment and model
...
python quickstart/configure.py quickstart/prepared/training.json
