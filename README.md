...
[![License: PolyForm Shield 1.0.0](https://img.shields.io/badge/License-PolyForm%20Shield%201.0.0-22c55e.svg)](https://github.com/PraveenNimilka/MOLT/blob/v0.11.0-alpha.7/LICENSE)
[![Python: 3.12](https://img.shields.io/badge/Python-3.12-22c55e.svg)](https://github.com/PraveenNimilka/MOLT/blob/v0.11.0-alpha.7/pyproject.toml)
[![Status: Alpha](https://img.shields.io/badge/Status-Alpha-4b5563.svg)](https://github.com/PraveenNimilka/MOLT/blob/v0.11.0-alpha.7/docs/releases/0.11.0-alpha.7.md)
...
[![PyPI: v0.11.0a7](https://img.shields.io/badge/PyPI-v0.11.0a7-blue.svg)](https://pypi.org/project/moltengine/0.11.0a7/)
...
**Latest release: 0.11.0a7 · Source-available research alpha.**
...
![Diagnostic reductions in elapsed time, board energy, and allocator peak, with 95% paired confidence intervals where applicable](https://raw.githubusercontent.com/PraveenNimilka/MOLT/v0.11.0-alpha.7/docs/assets/benchmark-diagnostic-0.11.0a3.svg)

See the [single reproduction page](https://github.com/PraveenNimilka/MOLT/blob/v0.11.0-alpha.7/docs/REPRODUCE_DIAGNOSTIC.md),
[calculation method, and machine-readable aggregate](https://github.com/PraveenNimilka/MOLT/blob/v0.11.0-alpha.7/docs/benchmarks/README.md).
...
Install MOLT, then let its setup command install and verify the complete CUDA,
...
```powershell
git clone --branch v0.11.0-alpha.7 --depth 1 https://github.com/PraveenNimilka/MOLT.git
Set-Location MOLT
...
See [the complete installation guide](https://github.com/PraveenNimilka/MOLT/blob/v0.11.0-alpha.7/docs/INSTALL.md) for troubleshooting.

## First training run

Want one copy-and-run example? Follow the [complete beginner recipe](https://github.com/PraveenNimilka/MOLT/blob/v0.11.0-alpha.7/docs/BEGINNER_QUICKSTART.md),
then watch the [75-second measured workflow demonstration](https://github.com/PraveenNimilka/MOLT/blob/v0.11.0-alpha.7/docs/demo/molt-launch-demo-75s.mp4)
and inspect its [full sanitized log](https://github.com/PraveenNimilka/MOLT/blob/v0.11.0-alpha.7/docs/demo/session.log).
...
See [SECURITY.md](https://github.com/PraveenNimilka/MOLT/blob/v0.11.0-alpha.7/SECURITY.md).
...
Read the [0.11.0a7 release notes](https://github.com/PraveenNimilka/MOLT/blob/v0.11.0-alpha.7/docs/releases/0.11.0-alpha.7.md),
[CLI reference](https://github.com/PraveenNimilka/MOLT/blob/v0.11.0-alpha.7/docs/cli.md), [support policy](https://github.com/PraveenNimilka/MOLT/blob/v0.11.0-alpha.7/SUPPORT.md), and
[licensing boundary](https://github.com/PraveenNimilka/MOLT/blob/v0.11.0-alpha.7/docs/licensing.md). Dependency attribution and branding
rules are recorded in [THIRD_PARTY_NOTICES.md](https://github.com/PraveenNimilka/MOLT/blob/v0.11.0-alpha.7/THIRD_PARTY_NOTICES.md) and
[TRADEMARKS.md](https://github.com/PraveenNimilka/MOLT/blob/v0.11.0-alpha.7/TRADEMARKS.md).

## License

Current MOLT source is available under the
[PolyForm Shield License 1.0.0](https://github.com/PraveenNimilka/MOLT/blob/v0.11.0-alpha.7/LICENSE). It is source-available, not OSI open
